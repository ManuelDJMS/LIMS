...
<?php 
    session_start();
    include_once("./dist/fw/Classes/conexion.php");
?>
<!doctype html>
<html lang="en">
    <head>
        ...
        <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
            <div class="app-header header-shadow">
                ...
                <div class="app-header__content">
                    <div class="app-header-left">
                        <div class="search-wrapper">
                            <div class="input-holder">
                                <input type="text" class="search-input" placeholder="Escribe algo que quieras buscar">
                    ...
                    </ul> HASTA ESTA PARTE SE PONEN LOS MENUS QUE ESTAN A UN LADO DE LA BUSQUEDA -->        
                    </div> 
                    <div class="app-header-right">
                                    ...
                                    <div class="dropdown-menu-header">
                                        <div class="dropdown-menu-header-inner bg-plum-plate">
                                            ...
                                            <div class="menu-header-content text-white">
                                                <h5 class="menu-header-title">Accesos Rápidos</h5>
                                                <h6 class="menu-header-subtitle">Selecciona alguna acción</h6>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="dropdown-menu-header mb-0">
                                        <div class="dropdown-menu-header-inner bg-deep-blue">
                                            ...
                                            <div class="menu-header-content text-dark">
                                                ...
                                                <h6 class="menu-header-subtitle">Tienes <b>21</b> mensajes si leer</h6>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        </div> <!-- TERMINA EL DIV DE LOS ICONOS (MENUS HEADER) -->
                                                            ...
                                                            <div class="widget-content p-0">
                                                                <div class="widget-content-wrapper">
                                                                    ...
                                                                    <div class="widget-content-right mr-2">
                                                                        <a href="logout.php"><button class="btn-pill btn-shadow btn-shine btn btn-focus">Logout</a>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        </div>  BOTON PARA ABRIR EL MENU DE LA DERECHA        -->
                    </div> <!-- DIV DEL HEADER PRINCIPAL -->
                </div> <!--DIV QUE CONTIENE TODO EL MENU PRINCUPAL O SEA EL HEADER-->
            </div> 
        <!--=============================================== DIV PRINCIPAL DE HEADER ==================================================== -->
        <!-- ================================= TODO ESTE CODIGO ES PARA LA PERSONALIZACION DE LA PAGINA ================================================-->
    ...
    <!-- AQUI TERMINA EL PROGRAMA DE DISEÑO -->