                            ...
                            <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                                ...
                                <?php 
                                    ...
                                    { 
                                        ...
                                        $conexion->conectar("LIMS");
                                        $sql="SELECT UserId, FName +' '+MName, Password,Department from UserMaster WHERE UserName= '$_email'";
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    <label for="exampleEmail" class="">Nombre de Usuario</label>
